...
function Main() {
    ...
    const filterTasks = (tasks, activeFilter) => {
        ...
        return tasks; // 'all' filter shows all tasks
    };
        ...
        <div className="container mx-auto p-4 md:p-8 max-w-4xl font-sans">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-1 bg-white p-6 rounded-lg shadow-md">
                    ...
                    {/* User List */}
                    <h3 className="text-lg font-medium mb-2 text-gray-600 border-t pt-4">
